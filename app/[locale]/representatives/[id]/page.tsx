          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {representative.constituencyName && (
                <div>
                  <p className="text-sm font-medium text-muted-foreground">{t('constituency')}</p>
              ...
              {representative.province && (
                <div>
                  <p className="text-sm font-medium text-muted-foreground">{t('province')}</p>
